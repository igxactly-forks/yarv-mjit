...
HTMLOUT       = $(EXTOUT)/html
CAPIOUT       = doc/capi
MJIT_MIN_HEADER = $(EXTOUT)/include/$(arch)/rb_mjit_min_header-$(RUBY_PROGRAM_VERSION)
...
main: $(SHOWFLAGS) exts $(ENCSTATIC:static=lib)encs $(MJIT_MIN_HEADER).h
	@$(NULLCMD)
